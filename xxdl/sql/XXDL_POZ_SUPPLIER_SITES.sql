...
CREATE
  ...
  "VENDOR_ID" NUMBER, 
	...
	"CLOUD_PAYEE_ID" NUMBER,
	"PAYMENT_METHOD_CODE" VARCHAR2(100)
   );
  
  
  CREATE UNIQUE INDEX "XXXDL_POZ_SUPPLIER_SITES_U1" ON "XXDL_POZ_SUPPLIER_SITES" ("VENDOR_SITE_ID", "BU_NAME") 
