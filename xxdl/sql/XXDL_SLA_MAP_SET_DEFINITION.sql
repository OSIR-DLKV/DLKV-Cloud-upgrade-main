...
insert into XXDL_SLA_MAP_SET_DEFINITION (mapping_set_code, application_name, out_segment, enabled, bi_report_name, bi_src_column)
values ('XXDL_AR_OM_CM_REC_CC', 'Receivables', 'Mjesto troska', 'Y', 'XXDL_CC_FROM_BILLABLE_PROJECT_REP', 'SOURCE_VALUE_2');
insert into XXDL_SLA_MAP_SET_DEFINITION (mapping_set_code, application_name, out_segment, enabled, bi_report_name, bi_src_column)
values ('XXDL_PROJ_FROM_SALES_ORDER', 'Cost Management', 'Projekt', 'Y', 'XXDL_PROJ_FROM_SALES_ORDER_REP', 'SOURCE_VALUE_1');
insert into XXDL_SLA_MAP_SET_DEFINITION (mapping_set_code, application_name, out_segment, enabled, bi_report_name, bi_src_column)
...
insert into XXDL_SLA_MAP_SET_DEFINITION (mapping_set_code, application_name, out_segment, enabled, bi_report_name, bi_src_column)
values ('XXDL_CC_FROM_SALES_ORDER', 'Cost Management', 'Mjesto troska', 'Y', 'XXDL_CC_FROM_SALES_ORDER_REP', 'SOURCE_VALUE_2');
insert into XXDL_SLA_MAP_SET_DEFINITION (mapping_set_code, application_name, out_segment, enabled, bi_report_name, bi_src_column)
